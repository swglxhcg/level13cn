		...
		update: function (time) {
			...
			if (this.campNodes.head) {
				...
				for (var campNode = this.campNodes.head; campNode; campNode = campNode.next) {
					...
					evidenceComponent.addChange("图书馆", accLibrary, campNode.position.level);
					evidenceComponent.addChange("科学家", accScientists, campNode.position.level);
					evidenceComponent.addChange("研究中心", accResearchCenter, campNode.position.level);
