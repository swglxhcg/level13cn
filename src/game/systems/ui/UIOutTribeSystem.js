define([
	...
	var UIOutTribeSystem = Ash.System.extend({
		...
		createCampRow: function (campOrdinal, rowID) {
			...
			rowHTML += "<td class='camp-overview-btn'><button class='btn-mini action action-move' id='" + btnID + "' action='" + btnAction + "'>冲刺</button></td>";
		...
		getAlertDescription: function (notificationType) {
			switch (notificationType) {
				case this.campNotificationTypes.EVENT_RAID_ONGOING: return "突袭";
				case this.campNotificationTypes.EVENT_TRADER: return "交易者";
				case this.campNotificationTypes.EVENT_RECRUIT: return "访问者";
				case this.campNotificationTypes.POP_UNASSIGNED: return "未分配的工人";
				case this.campNotificationTypes.POP_DECREASING: return "人口减少";
				case this.campNotificationTypes.EVENT_OUTGOING_CARAVAN: return "即将离开的商队";
				default: return "";
			}
		},
		...
		getNotificationMessage: function (notificationType, level) {
			...
			switch (notificationType) {
				case this.campNotificationTypes.EVENT_RAID_RECENT:
					...
					let timeS = "(" + UIConstants.getTimeSinceText(campComponent.lastRaid.timestamp) + " 之前)";
					return "有一层被突袭了 " + level + " " + timeS + ". 我们需要更好的防御.";
				...
				case this.campNotificationTypes.EVENT_TRADER:
					...
					return "有一个商人 (" + traderComponent.caravan.name + ") 现在在 " + level + "层.";
				...
				case this.campNotificationTypes.EVENT_OUTGOING_CARAVAN:
					...
					let caravanTimeS = timeLeft < 30 ? "非常快" : UIConstants.getTimeToNum(timeLeft);
					
				 	return "大篷车驶离该层 " + level + " (预计将于 " + caravanTimeS + "返回).";
					
				case this.campNotificationTypes.EVENT_RECRUIT: return "当前有一个访问者在 " + level + "层.";
				case this.campNotificationTypes.POP_UNASSIGNED: return "未分配的工人在 " + level + "层.";
				case this.campNotificationTypes.POP_DECREASING: return "人口正在减少，在 " + level + "层!";
				case this.campNotificationTypes.POP_INCREASING: return "人口在一定程度上增长，在 " + level + "层.";
				case this.campNotificationTypes.STATUS_NON_REACHABLE_BY_TRADERS: return "第 " + level + "层的营地不能和其他阵营交换资源.";
				default: return null;
			}
		},
