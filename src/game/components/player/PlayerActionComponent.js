define(['ash', 'game/GameGlobals', 'game/vos/PlayerActionVO'], function (Ash, GameGlobals, PlayerActionVO) {
	...
	var PlayerActionComponent = Ash.Class.extend({
		...
		getBusyDescription: function () {
			...
			switch (baseActionID) {
				case "use_in_home": return "休息";
				case "use_in_campfire": return "讨论";
				case "use_in_hospital": return "恢复";
				case "use_in_hospital_2": return "扩张";
				case "use_in_market": return "访问";
				case "use_in_temple": return "朝拜";
				case "use_in_shrine": return "冥想";
				case "clear_waste_t": return "清理垃圾";
				case "clear_waste_r": return "清理垃圾";
