...
function (Ash, PlayerActionData, GameConstants, CampConstants, ImprovementConstants) {
	...
	var PlayerActionConstants = {
		...
		UNAVAILABLE_REASON_LOCKED_RESOURCES: '需要未发现的资源.',
		UNAVAILABLE_REASON_BAG_FULL: '袋子里装满了.',
		UNAVAILABLE_REASON_NOT_IN_CAMP: '一定是在营地里干.',
		UNAVAILABLE_REASON_POPULATION: "UNAVAILABLE_REASON_POPULATION",
		DISABLED_REASON_NOT_ENOUGH_LEVEL_POP: '这一层的人还不够多.',
		DISABLED_REASON_NOT_REACHABLE_BY_TRADERS: "贸易商无法到达营地.",
		UNAVAILABLE_REASON_BUSY: '忙于',
		UNAVAILABLE_REASON_MAX_IMPROVEMENT_LEVEL: '最大层数',
