define(['ash', 'game/vos/PositionVO'], function (Ash, PositionVO) {
	...
	var PositionConstants = {
		...
		getDirectionName: function (direction, short) {
			switch (direction) {
				case this.DIRECTION_WEST: return short ? "W" : "西";
				case this.DIRECTION_NORTH: return short ? "N" : "北";
				case this.DIRECTION_SOUTH: return short ? "S" : "南";
				case this.DIRECTION_EAST: return short ? "E" : "东";
				case this.DIRECTION_NE: return short ? "NE" : "东北";
				case this.DIRECTION_SE: return short ? "SE" : "东南";
				case this.DIRECTION_SW: return short ? "SW" : "西南";
				case this.DIRECTION_NW: return short ? "NW" : "西北";
				case this.DIRECTION_UP: return short ? "U" : "上";
				case this.DIRECTION_DOWN: short ? "D" : "下";
				case this.DIRECTION_CAMP: short ? "C" : "营地";
